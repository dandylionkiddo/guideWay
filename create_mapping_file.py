...
output_json_path = 'D:/AIffel/EfficientViT/efficientvit/applications/efficientvit_seg/custom_class_mapping.json'

# Define the new class order
new_class_names = [
    'sidewalk', 'curb', 'curb-cut', 'crosswalk', 'road', 'minor-road', 'bike-lane', 'terrain',
    'cautious-zone', 'repair-zone', 'car-four-wheeled', 'motorcycle', 'micromobility', 'other-vehicle', 'person',
    'pothole', 'manhole', 'drain', 'background'
]
